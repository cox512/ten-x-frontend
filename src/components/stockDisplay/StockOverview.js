  ...
  return (
    <main className="stock-overview display">
      <section className="stock-overview__section lead">
        <div>{stockOverview.Name}</div>
        <div>({stockOverview.Symbol})</div>
      ...
      <section className="stock-overview__section display display--large">
        <div>
          <h2 className="stock-overview__category">Company Overview</h2>
          <div className="inline-row">
            <p className="stock-overview__item">
              Country: <span>{stockOverview.Country}</span>
            </p>
        ...
        <div>
          <h2 className="stock-overview__category">Earnings Numbers</h2>
          <div>
            <p className="stock-overview__item">
              Market Cap <i>(million)</i>:{" "}
              <span>{formatter.format(stockOverview.MarketCapitalization / 1000000)}</span>
            ...
            <p className="stock-overview__item">
              EBITDA <i>(million)</i>:{" "}
              <span>{formatter.format(stockOverview.EBITDA / 1000000)}</span>
            </p>
            <p className="stock-overview__item">
              EPS: <span>{formatter.format(stockOverview.EPS)}</span>
            </p>
            ...
            <p className="stock-overview__item">
              Price To Sales:{" "}
              <span>{parseFloat(stockOverview.PriceToSalesRatioTTM).toFixed(2)}</span>
            </p>
            <p className="stock-overview__item">
              Price To Book: <span>{parseFloat(stockOverview.PriceToBookRatio).toFixed(2)}</span>
            </p>
        ...
        <div>
          <h2 className="stock-overview__category">Performance Trends</h2>
          <div>
            <p className="stock-overview__item">
              52-Week High: <span>{formatter.format(stockOverview["52WeekHigh"])}</span>
            </p>
        ...
        <div>
          <h2 className="stock-overview__category inline-row">Dividend Information</h2>
          <div>
            <p className="stock-overview__item">
              Dividend Per Share: <span>{formatter.format(stockOverview.DividendPerShare)}</span>
            </p>
        ...
        <div>
          <h2 className="stock-overview__category inline-row">Ownership</h2>
          <div>
            <p className="stock-overview__item">
              Insider Ownership:{" "}
              <span>{parseFloat(stockOverview.PercentInsiders).toFixed(2)}%</span>
            </p>
            <p className="stock-overview__item">
              Institutional Ownership:{" "}
              <span>{parseFloat(stockOverview.PercentInstitutions).toFixed(2)}%</span>
